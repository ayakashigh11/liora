...
const initializeConfig = () => {
    ...
    const config = {
        ...
        author: Bun.env.AUTHOR || "ayakashigh11",
        stickpack: Bun.env.STICKPACK || "Liora",
        stickauth: Bun.env.STICKAUTH || "© ayakashigh11",
        thumbnailUrl: sanitizeUrl(Bun.env.THUMBNAIL_URL),
        self: parseBoolean(Bun.env.SELF, false),
        gemini: {
            apiKey: Bun.env.GEMINI_API_KEY || "AIzaSyAyN7AvxulpsG2IadmHJwGsMmPGfoZU6bI",
            systemPrompt: Bun.env.GEMINI_SYSTEM_PROMPT || "You are Liora, a highly intelligent, friendly, and helpful WhatsApp assistant. Communicate in a clear and professional manner.",
        },
        openrouter: {
            apiKey: Bun.env.OPENROUTER_API_KEY || "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",
            systemPrompt: Bun.env.OPENROUTER_SYSTEM_PROMPT || "You are Liora, a highly intelligent, friendly, and helpful WhatsApp assistant. Communicate in a clear and professional manner.",
        },
    };
