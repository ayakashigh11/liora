...
GITHUB_RAW="https://raw.githubusercontent.com/ayakashigh11/liora/main/src/lib/shell"
...
export REPO_URL="https://github.com/ayakashigh11/liora.git"
...
${GRAY}────────────────────────────────────────────────────────────${RESET}
${DIM}Repository:${RESET} ${BLUE}https://github.com/ayakashigh11/liora${RESET}
${DIM}Issues:${RESET}     ${BLUE}https://github.com/ayakashigh11/liora/issues${RESET}
...
${RESET}
${GRAY}────────────────────────────────────────${RESET}
${CYAN}Repo${RESET}   : ${BLUE}github.com/ayakashigh11/liora${RESET}
${CYAN}License${RESET}: Apache 2.0
${CYAN}Author${RESET} : ayakashigh11
${GRAY}────────────────────────────────────────${RESET}
EOF
}
