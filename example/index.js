...
const { color } = require('./satanic/lib/color');
const { smsg, sleep, getBuffer } = require('./satanic/lib/myfunction');
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid, addExif } = require('./satanic/lib/exif')
...
const clientstart = async() => {
    ...
    client.ev.on('connection.update', (update) => {
        const { konek } = require('./satanic/lib/connection/connect')
